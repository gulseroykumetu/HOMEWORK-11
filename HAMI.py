...
inflation_url = "http://filetransfer.io/data-package/jFBrFFxt/download"
...
inflation_data = pandas.read_excel("Indonesia_inflation_rate.xlsx")
...
gdp_list = list(gdp_data.iloc[104].ravel()[35:-2])
unemployment_list = list(unemployment_data.iloc[104].ravel()[35:-2])
inflation_list = list(inflation_data[inflation_data.columns.ravel()[2]][5:34])
interest_list = list(interest_data.iloc[104].ravel()[35:-2])
